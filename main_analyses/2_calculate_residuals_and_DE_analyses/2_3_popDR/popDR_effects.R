...
setwd(current)
system(paste0("mkdir -p outputs/",folder,"/2_3_popDR_results/"))
...
## outputs
results_dir <- paste0("outputs/",folder,"/2_3_popDR_results/")
...
for (i in 1:length(celltypes)){
	...
	results <- cbind(infection_betas_sign, betas_flu, p_values_flu, fdrs_flu)
  	assign(paste0(cell_type_i,"_results_popDR"), results)
